...
Copy this directory to `/home/warren/commu/server_side_zero_transport` on the
GPU server. All experiment components run there and use loopback. This
scaffold never starts, restarts, signals, or kills vLLM.
...
passes. Stop with Ctrl-C; cleanup affects only recorded auxiliary child PIDs.
